...

{
  ...
  <BounceLoader color='#ee3d40' />
    ...
    <Link to={'/forgetPassword'} className='text-sm text-main text-blue-500'>forget password ?</Link>
  <button type="submit" className="text-white bg-[#ee3d40]  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm block ml-auto w-full sm:w-auto  px-5 py-2.5 text-center ">Login</button>
  </div>
